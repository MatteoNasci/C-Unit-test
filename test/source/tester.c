...
TEST(testing_passes2 , 
    ...
    ASSERT_IN_RANGEf(0, 0.001, 0.01, "%f")
...
MLN_TEST(testing_assert_skip_skip2, 
    ASSERTi(true)
    ASSERTi(false)
    PASS()
)
MLN_TEST(testing_assert_skip_skip_prefix2, 
    MLN_ASSERTi(true)
    MLN_ASSERTi(false)
    MLN_PASS()
)
...
void test(const size_t verbosity, const bool wait_input){
    ...
    RUN_TEST(testing_bypass_fail_skip2)
    printf("Needs to fail with no passes\n");
    RUN_TEST(testing_bypass_fail_skip_prefix2)
    printf("Needs to fail with no passes\n");
    RUN_TEST(testing_bypass_failm_skip2)
    printf("Needs to fail with no passes\n");
    RUN_TEST(testing_bypass_failm_skip_prefix2)
    printf("Needs to fail with 1 pass\n");
    RUN_TEST(testing_assert_skip2)
    printf("Needs to fail with 1 pass\n");
    RUN_TEST(testing_assert_skip_prefix2)
    printf("Needs to fail with 2 pass\n");
    RUN_TEST(testing_assert_skip_skip2)
    printf("Needs to fail with 2 pass\n");
    RUN_TEST(testing_assert_skip_skip_prefix2)
    printf("Needs to fail all and not reach the final pass\n");
    RUN_TEST(testing_fails2)
    printf("Needs to fail all and not reach the final pass\n");
